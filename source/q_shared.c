...
// q_shared.c
//
// $Id: q_shared.c,v 1.3 2001/09/28 13:48:35 ra Exp $
//
//-----------------------------------------------------------------------------
// $Log: q_shared.c,v $
     ...
     int BoxOnPlaneSide (vec3_t emins, vec3_t emaxs, struct cplane_s *p)
{
  ...
  __asm
  {
    ...
    push ebx
      ...
      add cl, ah
      fnstsw ax
      and ah, 1 add ah, ah add cl, ah pop ebx mov eax, ecx ret Lerror:int 3}
}
#pragma warning( default: 4035 )
#endif
