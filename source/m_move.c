...
//
// $Id: m_move.c,v 1.2 2001/09/28 13:48:34 ra Exp $
//
//-----------------------------------------------------------------------------
// $Log: m_move.c,v $
...
//
// Revision 1.1.1.1  2001/05/06 17:29:29  igor_rock
...
// the midpoint must be within 16 of the bottom
  ...
  trace =
    gi.trace (start, vec3_origin, vec3_origin, stop, ent, MASK_MONSTERSOLID);
...
// flying monsters don't step up
  if (ent->flags & (FL_SWIM | FL_FLY))
      ...
      for (i = 0; i < 2; i++)
	{
	  ...
	  trace =
	    gi.trace (ent->s.origin, ent->mins, ent->maxs, neworg, ent,
		      MASK_MONSTERSOLID);
