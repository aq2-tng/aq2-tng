...
void
rotating_touch (edict_t * self, edict_t * other, cplane_t * plane,
		csurface_t * surf)
{
...
void
button_touch (edict_t * self, edict_t * other, cplane_t * plane,
	      csurface_t * surf)
{
  if (!other->client)
    return;
...
void
door_touch (edict_t * self, edict_t * other, cplane_t * plane,
	    csurface_t * surf)
{
  if (!other->client)
    return;
